...
class MyBot(TwitchBot):
	...
	@TwitchBot.new_command
	def merci_chosson(self, cmd: Chatbot.Command):
		self.send_privmsg("Merci pour cette session Chosson <3")
